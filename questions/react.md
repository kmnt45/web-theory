...
## 4. Что такое React Fiber? Как проходит согласование изменений DOM в React? Что такое конкурентный режим? Как его включить? Для чего конкурентный режим был введен на уровне архитектуры React?
